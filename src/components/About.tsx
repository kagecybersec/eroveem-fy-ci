...
const About = () => {
  ...
  return (
    <section id="apropos" className="section-corporate section-gradient">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="heading-lg text-foreground mb-6">À Propos de Nous</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="relative">
            <div className="aspect-w-16 aspect-h-10 rounded-lg overflow-hidden shadow-corporate">
              <img
                src={plateauOffice}
            ...
            <div className="absolute -bottom-6 -right-6 bg-secondary p-4 rounded-lg shadow-gold">
              <p className="text-secondary-foreground font-bold text-lg">Depuis 2008</p>
              <p className="text-secondary-foreground/80 text-sm">Au service de l'excellence</p>
            </div>
          </div>
        ...
        {/* Values Section */}
        <div>
          <h3 className="heading-md text-center text-foreground mb-12">Nos Valeurs</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="card-corporate text-center group hover:shadow-corporate transition-all duration-300">
                <div className="mb-6">
                  <div className="inline-flex p-4 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-colors duration-300">
